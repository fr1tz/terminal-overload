...
#ifndef _VITCTANKVEHICLE_H_
#define _VITCTANKVEHICLE_H_
...
struct vitcTankVehicleTire : public SimDataBlock
{
	...
	F32 radius;                // Tire radius
							   ...
							   //
	vitcTankVehicleTire();
	DECLARE_CONOBJECT(vitcTankVehicleTire);
...
struct vitcTankVehicleSpring : public SimDataBlock
{
	typedef SimDataBlock Parent;
	...
	F32 antiSway;              // Opposite wheel anti-sway
							   ...
							   //
	vitcTankVehicleSpring();
	DECLARE_CONOBJECT(vitcTankVehicleSpring);
	static void initPersistFields();
	virtual void packData(BitStream* stream);
	virtual void unpackData(BitStream* stream);
};
...
struct vitcTankVehicleData : public VehicleData
{
	...
	S32 steeringSequence;         // Steering animation
								  ...
								  //
	vitcTankVehicleData();
	DECLARE_CONOBJECT(vitcTankVehicleData);
	static void initPersistFields();
	bool preload(bool, String &errorStr);
...
class vitcTankVehicle : public Vehicle
{
	...
	enum MaskBits
	{
		...
		SteeringLeverMask = Parent::NextFreeMask << 1,
		NextFreeMask = Parent::NextFreeMask << 2
	};

	vitcTankVehicleData* mDataBlock;

	F32 mSteeringLever[2];
	...
	struct Wheel
	{
		vitcTankVehicleTire *tire;
		vitcTankVehicleSpring *spring;
		vitcTankVehicleData::Wheel* data;
	...
	Wheel mWheel[vitcTankVehicleData::MaxWheels];
...
public:
	DECLARE_CONOBJECT(vitcTankVehicle);
	static void initPersistFields();
	...
	void setWheelSteeringLever(S32 wheel, S32 lever);
	void setWheelPowered(S32 wheel, bool powered);
	void setWheelTire(S32 wheel, vitcTankVehicleTire*);
	void setWheelSpring(S32 wheel, vitcTankVehicleSpring*);
