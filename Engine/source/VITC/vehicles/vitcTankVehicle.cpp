...
#include "VITC/vehicles/vitcTankVehicle.h"
...
// Gravity constant
static F32 svitcTankVehicleGravity = -20;
...
IMPLEMENT_CO_DATABLOCK_V1(vitcTankVehicleTire);

ConsoleDocClass(vitcTankVehicleTire,
	"@brief Defines the properties of a vitcTankVehicle tire.\n\n"
...
vitcTankVehicleTire::vitcTankVehicleTire()
{
	shape = 0;
	shapeName = "";
	staticFriction = 1;
...
bool vitcTankVehicleTire::preload(bool server, String &errorStr)
{
	...
	if (shapeName && shapeName[0])
	{
		...
		if (!bool(shape))
		{
			errorStr = String::ToString("vitcTankVehicleTire: Couldn't load shape \"%s\"", shapeName);
			return false;
		}
...
void vitcTankVehicleTire::initPersistFields()
{
	addField("shapeFile", TypeShapeFilename, Offset(shapeName, vitcTankVehicleTire),
		"The path to the shape to use for the wheel.");
	addField("mass", TypeF32, Offset(mass, vitcTankVehicleTire),
		"The mass of the wheel.\nCurrently unused.");
	addField("radius", TypeF32, Offset(radius, vitcTankVehicleTire),
	...
	addField("staticFriction", TypeF32, Offset(staticFriction, vitcTankVehicleTire),
		"Tire friction when the wheel is not slipping (has traction).");
	addField("kineticFriction", TypeF32, Offset(kineticFriction, vitcTankVehicleTire),
		"Tire friction when the wheel is slipping (no traction).");
	addField("restitution", TypeF32, Offset(restitution, vitcTankVehicleTire),
		"Tire restitution.\nCurrently unused.");
	addField("lateralForce", TypeF32, Offset(lateralForce, vitcTankVehicleTire),
		...
		"force. vitcTankVehicles are acted upon by forces generated by their tires "
	...
	addField("lateralDamping", TypeF32, Offset(lateralDamping, vitcTankVehicleTire),
		"Damping force applied against lateral forces generated by the tire.\n\n"
		"@see lateralForce");
	addField("lateralRelaxation", TypeF32, Offset(lateralRelaxation, vitcTankVehicleTire),
		...
		"un-deforms.\n\n@see lateralForce");
	addField("longitudinalForce", TypeF32, Offset(longitudinalForce, vitcTankVehicleTire),
		"@brief Tire force in the direction of movement.\n\n"
		"Longitudinal force can in simple terms be considered forward/backward "
		"movement force. vitcTankVehicles are acted upon by forces generated by "
		...
		"@see lateralForce");
	addField("longitudinalDamping", TypeF32, Offset(longitudinalDamping, vitcTankVehicleTire),
		"Damping force applied against longitudinal forces generated by the tire.\n\n"
		"@see longitudinalForce");
	addField("longitudinalRelaxation", TypeF32, Offset(longitudinalRelaxation, vitcTankVehicleTire),
...
void vitcTankVehicleTire::packData(BitStream* stream)
{
...
void vitcTankVehicleTire::unpackData(BitStream* stream)
{
...
IMPLEMENT_CO_DATABLOCK_V1(vitcTankVehicleSpring);

ConsoleDocClass(vitcTankVehicleSpring,
	"@brief Defines the properties of a vitcTankVehicle spring.\n\n"
	"@ingroup Vehicles\n"
	);

vitcTankVehicleSpring::vitcTankVehicleSpring()
{
	length = 1;
	force = 10;
	damping = 1;
...
void vitcTankVehicleSpring::initPersistFields()
{
	addField("length", TypeF32, Offset(length, vitcTankVehicleSpring),
	...
	addField("force", TypeF32, Offset(force, vitcTankVehicleSpring),
	...
	addField("damping", TypeF32, Offset(damping, vitcTankVehicleSpring),
		...
		"bouncy vehicles.");
	addField("antiSwayForce", TypeF32, Offset(antiSway, vitcTankVehicleSpring),
...
void vitcTankVehicleSpring::packData(BitStream* stream)
{
	Parent::packData(stream);
...
void vitcTankVehicleSpring::unpackData(BitStream* stream)
{
	Parent::unpackData(stream);
...
IMPLEMENT_CO_DATABLOCK_V1(vitcTankVehicleData);

ConsoleDocClass(vitcTankVehicleData,
	"@brief Defines the properties of a vitcTankVehicle.\n\n"
	"@ingroup Vehicles\n"
	);

vitcTankVehicleData::vitcTankVehicleData()
{
	tireEmitter = 0;
	maxWheelSpeed = 40;
	engineTorque = 1;
...
*/
bool vitcTankVehicleData::preload(bool server, String &errorStr)
{
...
*/
bool vitcTankVehicleData::mirrorWheel(Wheel* we)
{
	we->opposite = -1;
...
void vitcTankVehicleData::initPersistFields()
{
	addField("jetSound", TYPEID< SFXTrack >(), Offset(sound[JetSound], vitcTankVehicleData),
		"Looping sound played when the vehicle is jetting.");
	addField("engineSound", TYPEID< SFXTrack >(), Offset(sound[EngineSound], vitcTankVehicleData),
		"@brief Looping engine sound.\n\n"
		"The pitch is dynamically adjusted based on the current engine RPM");
	addField("squealSound", TYPEID< SFXTrack >(), Offset(sound[SquealSound], vitcTankVehicleData),
	...
	addField("WheelImpactSound", TYPEID< SFXTrack >(), Offset(sound[WheelImpactSound], vitcTankVehicleData),
		"Sound played when the wheels impact the ground.\nCurrently unused.");

	addField("tireEmitter", TYPEID< ParticleEmitterData >(), Offset(tireEmitter, vitcTankVehicleData),
	...
	addField("maxWheelSpeed", TypeF32, Offset(maxWheelSpeed, vitcTankVehicleData),
		"@brief Maximum linear velocity of each wheel.\n\n"
		"This caps the maximum speed of the vehicle.");
	addField("engineTorque", TypeF32, Offset(engineTorque, vitcTankVehicleData),
	...
	addField("engineBrake", TypeF32, Offset(engineBrake, vitcTankVehicleData),
	...
	addField("brakeTorque", TypeF32, Offset(brakeTorque, vitcTankVehicleData),
...
void vitcTankVehicleData::packData(BitStream* stream)
{
	Parent::packData(stream);
...
void vitcTankVehicleData::unpackData(BitStream* stream)
{
	Parent::unpackData(stream);
...
//----------------------------------------------------------------------------
// VITC Tank Vehicle Class
//----------------------------------------------------------------------------

//----------------------------------------------------------------------------

IMPLEMENT_CO_NETOBJECT_V1(vitcTankVehicle);

ConsoleDocClass(vitcTankVehicle,
	"@brief A wheeled vehicle.\n"
	"@ingroup Vehicles\n"
	);

vitcTankVehicle::vitcTankVehicle()
{
	mDataBlock = 0;
	mSteeringLever[0] = 0;
	mSteeringLever[1] = 0;
	...
	for (S32 i = 0; i < vitcTankVehicleData::MaxWheels; i++) {
...
void vitcTankVehicle::initPersistFields()
{
	Parent::initPersistFields();
}
...
bool vitcTankVehicle::onNewDataBlock(GameBaseData* dptr, bool reload)
{
	...
	mDataBlock = dynamic_cast<vitcTankVehicleData*>(dptr);
	...
	if (isGhost())
	{
		...
		if (mDataBlock->sound[vitcTankVehicleData::EngineSound])
			mEngineSound = SFX->createSource(mDataBlock->sound[vitcTankVehicleData::EngineSound], &getTransform());

		if (mDataBlock->sound[vitcTankVehicleData::SquealSound])
			mSquealSound = SFX->createSource(mDataBlock->sound[vitcTankVehicleData::SquealSound], &getTransform());

		if (mDataBlock->sound[vitcTankVehicleData::JetSound])
			mJetSound = SFX->createSource(mDataBlock->sound[vitcTankVehicleData::JetSound], &getTransform());
	}
...
S32 vitcTankVehicle::getWheelCount()
{
	// Return # of hubs defined on the car body
	return mDataBlock ? mDataBlock->wheelCount : 0;
}

void vitcTankVehicle::setWheelSteeringLever(S32 wheel, S32 lever)
{
	AssertFatal(wheel >= 0 && wheel < vitcTankVehicleData::MaxWheels, "Wheel index out of bounds");
	mWheel[wheel].steeringLever = mClampF(lever, 0, 1);
	setMaskBits(WheelMask);
}

void vitcTankVehicle::setWheelSteering(S32 wheel, F32 steering)
{
	AssertFatal(wheel >= 0 && wheel < vitcTankVehicleData::MaxWheels, "Wheel index out of bounds");
...
void vitcTankVehicle::setWheelPowered(S32 wheel, bool powered)
{
	AssertFatal(wheel >= 0 && wheel < vitcTankVehicleData::MaxWheels, "Wheel index out of bounds");
...
void vitcTankVehicle::setWheelTire(S32 wheel, vitcTankVehicleTire* tire)
{
	AssertFatal(wheel >= 0 && wheel < vitcTankVehicleData::MaxWheels, "Wheel index out of bounds");
...
void vitcTankVehicle::setWheelSpring(S32 wheel, vitcTankVehicleSpring* spring)
{
	AssertFatal(wheel >= 0 && wheel < vitcTankVehicleData::MaxWheels, "Wheel index out of bounds");
...
void vitcTankVehicle::getWheelInstAndTransform(U32 index, TSShapeInstance** inst, MatrixF* xfrm) const
{
	AssertFatal(index < vitcTankVehicleData::MaxWheels,
		"vitcTankVehicle::getWheelInstAndTransform() - Bad wheel index!");
...
void vitcTankVehicle::processTick(const Move* move)
{
	Parent::processTick(move);
}

void vitcTankVehicle::updateMove(const Move* move)
{
	Parent::updateMove(move);

	if(this->isServerObject())
	{
		if(mSteeringLever[0] != move->x || mSteeringLever[1] != move->z)
			this->setMaskBits(SteeringLeverMask);
		mSteeringLever[0] = move->x;
		mSteeringLever[1] = move->z;
	}

	//Con::printf("%s: %f %f", isGhost() ? "CLNT" : "SRVR", mSteeringLever[0], mSteeringLever[1]);
...
void vitcTankVehicle::advanceTime(F32 dt)
{
	PROFILE_SCOPE(vitcTankVehicle_AdvanceTime);
...
*/
void vitcTankVehicle::updateForces(F32 dt)
{
	PROFILE_SCOPE(vitcTankVehicle_UpdateForces);
	...
	for (Wheel* wheel = mWheel; wheel < wend; wheel++)
	{
		...
		if (true) // tank steering
		{
			F32 steeringLever = mSteeringLever[wheel->steeringLever];
			...
			F32 dirMod = steeringLever < 0 ? -1 : 1;
			wheel->avel += (((wheel->torqueScale*engineTorque*dirMod) - Fy *
				wheel->tire->radius) / aMomentum) * dt;

			F32 targetAvel = maxAvel*steeringLever;

			if (mFabs(wheel->avel) > mFabs(targetAvel))
				wheel->avel = targetAvel;
		}
		else // normal steering mode...
		{
			if (wheel->powered)
			{
				F32 maxAvel = mDataBlock->maxWheelSpeed / wheel->tire->radius;
	...
	mRigid.force += Point3F(0, 0, -mBuoyancy * svitcTankVehicleGravity * mRigid.mass);
	...
	// Gravity
	mRigid.force += Point3F(0, 0, svitcTankVehicleGravity * mRigid.mass);
...
to the ground).
*/
void vitcTankVehicle::extendWheels(bool clientHack)
{
	PROFILE_SCOPE(vitcTankVehicle_ExtendWheels);
...
on the client.
*/
void vitcTankVehicle::updateWheelThreads()
{
	Wheel* wend = &mWheel[mDataBlock->wheelCount];
	for (Wheel* wheel = mWheel; wheel < wend; wheel++)
	{
...
*/
void vitcTankVehicle::updateWheelParticles(F32 dt)
{
	// OMG l33t hax
	extendWheels(true);
...
*/
void vitcTankVehicle::updateEngineSound(F32 level)
{
	if (!mEngineSound)
		return;
...
This method is only invoked by clients.
*/
void vitcTankVehicle::updateSquealSound(F32 level)
{
	if (!mSquealSound)
		return;
...
This method is only invoked by clients.
*/
void vitcTankVehicle::updateJetSound()
{
	if (!mJetSound)
		return;
...
U32 vitcTankVehicle::getCollisionMask()
{
...
and the wheels.
*/
bool vitcTankVehicle::buildPolyList(PolyListContext context, AbstractPolyList* polyList, const Box3F& box, const SphereF& sphere)
{
	PROFILE_SCOPE(vitcTankVehicle_BuildPolyList);
...
void vitcTankVehicle::prepBatchRender(SceneRenderState* state, S32 mountedImageIndex)
{
...
void vitcTankVehicle::writePacketData(GameConnection *connection, BitStream *stream)
{
...
void vitcTankVehicle::readPacketData(GameConnection *connection, BitStream *stream)
{
...
U32 vitcTankVehicle::packUpdate(NetConnection *con, U32 mask, BitStream *stream)
{
	...
	if (stream->writeFlag(mask & WheelMask))
	{
		...
		for (Wheel* wheel = mWheel; wheel < wend; wheel++)
		{
			if (stream->writeFlag(wheel->tire && wheel->spring))
			{
				...
				stream->write(wheel->steeringLever);
	...
	if (stream->writeFlag(mask & SteeringLeverMask))
	{
		stream->write(mSteeringLever[0]);
		stream->write(mSteeringLever[1]);
	}
...
void vitcTankVehicle::unpackUpdate(NetConnection *con, BitStream *stream)
{
	...
	if (stream->readFlag())
	{
		...
		for (Wheel* wheel = mWheel; wheel < wend; wheel++)
		{
			if (stream->readFlag())
			{
				...
				{
					con->setLastError("Invalid packet vitcTankVehicle::unpackUpdate()");
					return;
				}
				wheel->powered = stream->readFlag();
				stream->read(&wheel->steeringLever);
	...
	if (stream->readFlag())
	{
		stream->read(&mSteeringLever[0]);
		stream->read(&mSteeringLever[1]);
	}
...
DefineEngineMethod(vitcTankVehicle, setWheelSteeringLever, bool, (S32 wheel, S32 lever), ,
	"@brief Set which steering lever controls this wheel.\n\n"
	"@param wheel index of the wheel to set (hub node #)\n"
	"@param lever which lever (0=left, 1=right)\n"
	"@return true if successful, false if failed\n\n")
{
	if (wheel >= 0 && wheel < object->getWheelCount()) {
		object->setWheelSteeringLever(wheel, lever);
		return true;
	}
	else
...
DefineEngineMethod(vitcTankVehicle, setWheelPowered, bool, (S32 wheel, bool powered), ,
...
DefineEngineMethod(vitcTankVehicle, setWheelTire, bool, (S32 wheel, vitcTankVehicleTire* tire), ,
	"@brief Set the vitcTankVehicleTire datablock for this wheel.\n"
	"@param wheel index of the wheel to set (hub node #)\n"
	"@param tire vitcTankVehicleTire datablock\n"
	"@return true if successful, false if failed\n\n"
	"@tsexample\n"
...
DefineEngineMethod(vitcTankVehicle, setWheelSpring, bool, (S32 wheel, vitcTankVehicleSpring* spring), ,
	"@brief Set the vitcTankVehicleSpring datablock for this wheel.\n"
	"@param wheel index of the wheel to set (hub node #)\n"
	"@param spring vitcTankVehicleSpring datablock\n"
	"@return true if successful, false if failed\n\n"
	"@tsexample\n"
...
DefineEngineMethod(vitcTankVehicle, getWheelCount, S32, (), ,
