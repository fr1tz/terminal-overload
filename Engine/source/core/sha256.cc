...
{
  sha256_update((context_sha256_t *)ctx,buf,(U32) len);
}
...
void sha256_process( context_sha256_t *ctx, const U8 data[64] );
void sha256_process( context_sha256_t *ctx, const U8 data[64] )
{
