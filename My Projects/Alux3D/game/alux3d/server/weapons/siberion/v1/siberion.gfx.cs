...
datablock ParticleEmitterData(WpnSiberionProjectileExplosionSparkEmitter : DefaultEmitter)
{
   particles = "WpnSiberionProjectileExplosionSparkParticle";
   ejectionPeriodMS = "1";
   thetaMax = "90";
   phiVariance = "360";
   orientParticles = "1";
...
datablock ParticleData(WpnSiberionProjectileExplosionPlasmaParticles)
{
...
datablock ParticleEmitterData(WpnSiberionProjectileExplosionPlasmaEmitter)
{
   ejectionPeriodMS = "1";
   ejectionVelocity = "15";
   velocityVariance = "5";
   thetaMax = "180";
   softnessDistance = "1";
   particles = "WpnSiberionProjectileExplosionPlasmaParticles";
   lifetimeMS = "15";
   blendStyle = "ADDITIVE";
   softParticles = "0";
   useEmitterColors = "0";
...
datablock ParticleData(WpnSiberionProjectileExplosionCloudParticle : DefaultParticle)
{
   sizes[0] = "0";
   sizes[1] = "1.5";
   sizes[2] = "0";
...
datablock ParticleEmitterData(WpnSiberionProjectileExplosionCloudEmitter : DefaultEmitter)
{
   ejectionVelocity = "0";
   ejectionOffset = "0";
   particles = "WpnSiberionProjectileExplosionCloudParticle";
   ejectionPeriodMS = "1";
   lifetimeMS = "1";
   originalName = "WpnSiberionProjectileExplosionCloudEmitter";
   thetaMax = "153";
   softnessDistance = "1";
};
