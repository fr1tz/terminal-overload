...
datablock ShapeBaseImageData(WpnSiberionImage)
{
   ...
   shapeFileFP = "content/fr1tz/oldshapes/siberion/image/p1/shape.fp.dae";
   emap = true;
   ...
   casing = WpnSiberionProjectileShell;
   ...
   // Script fields
   reloadImage = WpnSiberionReloadImage;
   item = WpnSiberion;
   ammo = WpnSiberionAmmo;
   //clip = WpnSiberionClip;
   magazineCapacity = 30;
   ...
   stateSound[1]                    = WpnSiberionSwitchinSound;
   ...
   stateSound[3]                    = WpnSiberionIdleSound;
   ...
   stateFire[5]                     = true;
   stateFireProjectile[5]           = WpnSiberionPseudoProjectile;
   ...
   stateSound[5]                    = WpnSiberionFireSound;
   //stateEmitter[5]                  = WpnSiberionFireSmokeEmitter;
   ...
   stateSound[12]                   = WpnSiberionReleaseMagazineSound;
   ...
   stateSound[8]                    = WpnSiberionDryFireSound;
};

function WpnSiberionImage::onMount(%this, %obj, %slot)
{
