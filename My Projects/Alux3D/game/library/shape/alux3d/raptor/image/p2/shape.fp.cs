...
singleton TSShapeConstructor(Shape_Alux3D_Raptor_Image_P2_FP)
{
   baseShape = "./shape.fp.dae";
};

function Shape_Alux3D_Raptor_Image_P2_FP::onLoad(%this)
{
   ...
   %this.addSequence("timeline", "reload", "80", "130", "1", "0");
