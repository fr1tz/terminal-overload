...
singleton Material(Bulldog_ScopeScreen_Base)
{
   ...
   diffuseMap[0] = "content/fr1tz/oldshapes/bulldog/image/p1/Bulldog_D.dds";
   specular[0] = "1 1 1 1";
   specularPower[0] = "10";
...
singleton Material(Bulldog_Base)
{
   mapTo = "Bulldog_Base";
   diffuseMap[0] = "content/fr1tz/oldshapes/bulldog/image/p1/Bulldog_D.dds";
   normalMap[0] = "content/fr1tz/oldshapes/bulldog/image/p1/Bulldog_N.dds";
   specularMap[0] = "content/fr1tz/oldshapes/bulldog/image/p1/Bulldog_S.dds";
   specular[0] = "1 1 1 1";
   specularPower[0] = "1";
   translucentBlendOp = "None";
   useAnisotropic[0] = "0";
...
singleton Material(Bulldog_MuzzleFlash_Base)
{
   ...
   diffuseMap[0] = "content/fr1tz/oldshapes/bulldog/image/p1/Bulldog_MuzzleFlash.dds";
