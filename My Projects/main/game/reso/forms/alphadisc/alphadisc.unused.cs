...
datablock ParticleData(FrmAlphaDiscSkidTrailEmitter0_Particle)
{
	dragCoefficient		= 0.0;
...
datablock ParticleEmitterData(FrmAlphaDiscSkidTrailEmitter0)
{
	ejectionPeriodMS = 2;
	periodVarianceMS = 0;
	ejectionVelocity = 10;
	...
	particles = FrmAlphaDiscSkidTrailEmitter0_Particle;
};

datablock ParticleData(FrmAlphaDiscSkidTrailEmitter1_Particle)
{
	dragCoefficient		= 1.0;
...
datablock ParticleEmitterData(FrmAlphaDiscSkidTrailEmitter1)
{
	ejectionPeriodMS = 5;
	periodVarianceMS = 0;
	ejectionVelocity = 0;
	...
	lifetimeMS		 = 0; // forever
	particles = FrmAlphaDiscSkidTrailEmitter1_Particle;
};
...
datablock DebrisData(FrmAlphaDiscDamageDebris)
{
    // 2d billboard...
    render2D = true;
...
datablock DebrisData(FrmAlphaDiscBufferDamageDebris)
{
    // 2d billboard...
    render2D = true;
...
datablock ParticleData(FrmAlphaDiscBufferRepairEmitter_Particle)
{
	dragCoefficient		= 0.0;
	gravityCoefficient	= 0.0;
	inheritedVelFactor	= 0.0;
...
datablock ParticleEmitterData(FrmAlphaDiscBufferRepairEmitter)
{
	ejectionPeriodMS = 10;
	periodVarianceMS = 0;
	...
	orientParticles  = false;
	lifetimeMS		 = 0; // forever
	particles = FrmAlphaDiscBufferRepairEmitter_Particle;
};
