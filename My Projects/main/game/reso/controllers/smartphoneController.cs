...
function createSmartphoneController(%client, %cid, %sessionId)
{
...
function SmartphoneController::sendMsg(%this, %msg)
{
   ...
   commandToClient(%this.client, '_ResoMessageToController', %this.cid, %msg);
}
