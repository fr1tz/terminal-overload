...
datablock ShapeBaseImageData(WpnMGL2Image)
{
   ...
   projectile = WpnMGL2PseudoProjectile;

   casing = WpnMGL2ProjectileShell;
   ...
   item = WpnMGL2;
	...
	//
      ...
      stateWaitForTimeout[2]           = false;
		...
		stateFire[3]                     = true;
		stateFireProjectile[3]           = WpnMGL2PseudoProjectile;
		stateRecoil[3]                   = "LightRecoil";
		stateAllowImageChange[3]         = false;
		stateEjectShell[3]               = true;
		stateArmThread[3]                = "aimrifle";
		stateSequence[3]                 = "Fire";
		stateSound[3]                    = WpnMGL2FireSound;
      stateSoundFlags[3]               = 1;
...
function WpnMGL2Image::onMount(%this, %obj, %slot)
{
