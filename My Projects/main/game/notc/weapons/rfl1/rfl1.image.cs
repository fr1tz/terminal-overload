...
datablock ShapeBaseImageData(WpnRFL1Image)
{
   ...
   item = WpnRFL1;
	...
	//
      ...
      stateWaitForTimeout[2]           = false;
		...
		stateFire[3]                     = true;
		stateFireProjectile[3]           = WpnRFL1PseudoProjectile;
		stateRecoil[3]                   = "LightRecoil";
		stateAllowImageChange[3]         = false;
		stateEjectShell[3]               = true;
		stateArmThread[3]                = "aimrifle";
		stateSequence[3]                 = "Fire";
		stateSound[3]                    = WpnRFL1FireSound;
      stateSoundFlags[3]               = 1;
...
function WpnRFL1Image::onMount(%this, %obj, %slot)
{
