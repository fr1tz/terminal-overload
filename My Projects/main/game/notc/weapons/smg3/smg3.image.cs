...
datablock ShapeBaseImageData(WpnSMG3Image)
{
   // Basic Item properties
   shapeFile = "content/xa/notc/core/shapes/sg1/image/p2/shape.tp.dae";
   shapeFileFP = "content/xa/notc/core/shapes/smg3/image/p1/shape.fp.dae";
   emap = true;
   ...
   projectile = WpnSMG3Projectile;

   casing = WpnSMG3ProjectileShell;
   ...
   // Script fields
   reloadImage = WpnSMG3ReloadImage;
   item = WpnSMG3;
   ammo = WpnSMG3Ammo;
   //clip = WpnSMG3Clip;
   magazineCapacity = 30;
	...
	//
      ...
      stateFire[5]                     = true;
      stateFireProjectile[5]           = WpnSMG3Projectile;
      ...
      stateSound[5]                    = WpnSMG3FireSound;
      //stateSoundFlags[5]               = 0;
      //stateScript[5]                 = "onFire";
      //stateEmitter[5]                = WpnSMG3FireSmokeEmitter;
...
function WpnSMG3Image::onMount(%this, %obj, %slot)
{
