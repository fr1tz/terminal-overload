...
datablock ParticleData(WpnSMG3ProjectileImpactExplosion_DebrisParticles)
{
	spinSpeed = 200;
	spinRandomMin = -200.0;
	spinRandomMax =  200.0;
...
datablock ParticleEmitterData(WpnSMG3ProjectileImpactExplosion_DebrisEmitter)
{
	ejectionPeriodMS = 50;
	periodVarianceMS = 0;
	...
	particles = "WpnSMG3ProjectileImpactExplosion_DebrisParticles";
};


datablock ExplosionData(WpnSMG3ProjectileHit)
{
