...
datablock ParticleData(WpnSMG3ProjectileImpact_DebrisParticles)
{
	spinSpeed = 200;
	spinRandomMin = -200.0;
	spinRandomMax =  200.0;
...
datablock ParticleEmitterData(WpnSMG3ProjectileImpact_DebrisEmitter)
{
	ejectionPeriodMS = 50;
	periodVarianceMS = 0;
	...
	particles = "WpnSMG3ProjectileImpact_DebrisParticles";
};
...
datablock ExplosionData(WpnSMG3ProjectileImpact)
{
   ...
   emitter[2] = WpnSMG3ProjectileExplosion_CloudEmitter;
	...
	//debris = WpnSMG3ProjectileImpactExplosion_Debris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 60;
	//debrisNum = 1;
	//debrisNumVariance = 1;
