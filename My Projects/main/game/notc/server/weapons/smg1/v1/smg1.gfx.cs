...
datablock ParticleEmitterData(WpnSMG1ProjectileExplosionSparkEmitter : DefaultEmitter)
{
   particles = "WpnSMG1ProjectileExplosionSparkParticle";
   ejectionPeriodMS = "1";
   thetaMax = "90";
   phiVariance = "360";
   orientParticles = "1";
...
datablock ParticleData(WpnSMG1ProjectileExplosionPlasmaParticles)
{
...
datablock ParticleEmitterData(WpnSMG1ProjectileExplosionPlasmaEmitter)
{
   ejectionPeriodMS = "1";
   ejectionVelocity = "15";
   velocityVariance = "5";
   thetaMax = "180";
   softnessDistance = "1";
   particles = "WpnSMG1ProjectileExplosionPlasmaParticles";
   lifetimeMS = "15";
   blendStyle = "ADDITIVE";
   softParticles = "0";
   useEmitterColors = "0";
...
datablock ParticleData(WpnSMG1ProjectileExplosionCloudParticle : DefaultParticle)
{
   sizes[0] = "0";
   sizes[1] = "2.08333";
   sizes[2] = "0";
...
datablock ParticleEmitterData(WpnSMG1ProjectileExplosionCloudEmitter : DefaultEmitter)
{
   ejectionVelocity = "0";
   ejectionOffset = "0";
   particles = "WpnSMG1ProjectileExplosionCloudParticle";
   ejectionPeriodMS = "1";
   lifetimeMS = "5";
   originalName = "WpnSMG1ProjectileExplosionCloudEmitter";
   thetaMax = "153";
   softnessDistance = "1";
};
