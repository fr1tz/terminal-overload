...
datablock ShapeBaseImageData(WpnMG1Image)
{
   ...
   magazineCapacity = 30;
	...
	//
		...
		stateSound[3]                    = WpnMG1SpinUpSound;
		...
		stateSound[4]                    = WpnMG1FireSound;
		stateEmitter[4]                  = WpnMG1FireEmitter;
		...
		stateSound[5]                    = WpnMG1SpinDownSound;
...
function WpnMG1Image::getBulletSpread(%this, %obj)
{
