...
datablock ShapeBaseImageData(WpnSR2Image)
{
   ...
   projectile = WpnSR2Projectile;

   casing = WpnSR2ProjectileShell;
   ...
   magazineCapacity = 30;
	...
	//
		...
		stateSound[3]                    = WpnSR2ChargeSound;
		...
		stateFire[5]                     = true;
		stateFireProjectile[5]           = WpnSR2Projectile;
      ...
      stateSound[5]                    = WpnSR2FireSound;
		...
		stateSound[13]                    = WpnSR2ChargeSound;
...
function WpnSR2Image::onMount(%this, %obj, %slot)
{
   Parent::onMount(%this, %obj, %slot);
}

function WpnSR2Image::onUnmount(%this, %obj, %slot)
{
...
function WpnSR2Image::onReady(%this, %obj, %slot)
{
	//error("onReady");
   %obj.allowSprinting(true);
   if(%obj.hasInventory(ItemEtherboard))
...
function WpnSR2Image::onCharge(%this, %obj, %slot)
{
	//error("onCharge");
   //%obj.sniperTarget = "";
...
function WpnSR2Image::onFire(%this, %obj, %slot)
{
	//error("onFire");
   %obj.allowSprinting(true);
   if(%obj.hasInventory(ItemEtherboard))
...
function WpnSR2Image::onNoAmmo(%this, %obj, %slot)
{
	//error("onNoAmmo");
   %obj.allowSprinting(true);
   if(%obj.hasInventory(ItemEtherboard))
