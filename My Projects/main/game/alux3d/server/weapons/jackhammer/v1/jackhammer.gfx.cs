...
datablock ParticleData(WpnJackhammerProjectileExplosionSparkParticle : DefaultParticle)
{
   sizes[0] = "0.25";
   sizes[1] = "0.5";
   sizes[2] = "0";
...
datablock ParticleEmitterData(WpnJackhammerProjectileExplosionSparkEmitter : DefaultEmitter)
{
   particles = "WpnJackhammerProjectileExplosionSparkParticle";
   ejectionPeriodMS = "1";
   thetaMax = "90";
   phiVariance = "360";
   orientParticles = "1";
...
datablock ParticleData(WpnJackhammerProjectileExplosionPlasmaParticles)
{
...
datablock ParticleEmitterData(WpnJackhammerProjectileExplosionPlasmaEmitter)
{
   ejectionPeriodMS = "1";
   ejectionVelocity = "15";
   velocityVariance = "5";
   thetaMax = "180";
   softnessDistance = "1";
   particles = "WpnJackhammerProjectileExplosionPlasmaParticles";
   lifetimeMS = "15";
   blendStyle = "ADDITIVE";
   softParticles = "0";
   useEmitterColors = "0";
...
datablock ParticleData(WpnJackhammerProjectileExplosionCloudParticle : DefaultParticle)
{
   sizes[0] = "0";
   sizes[1] = "1.5";
   sizes[2] = "0";
...
datablock ParticleEmitterData(WpnJackhammerProjectileExplosionCloudEmitter : DefaultEmitter)
{
   ejectionVelocity = "0";
   ejectionOffset = "0";
   particles = "WpnJackhammerProjectileExplosionCloudParticle";
   ejectionPeriodMS = "1";
   lifetimeMS = "1";
   originalName = "WpnJackhammerProjectileExplosionCloudEmitter";
   thetaMax = "153";
   softnessDistance = "1";
};

datablock ExplosionData(WpnJackhammerProjectileExplosion)
{
   lifetimeMS = "96";
   ...
   soundProfile = "WpnJackhammerProjectileExplosionSound";
   lightEndRadius = "0";
};

datablock DebrisData(WpnJackhammerProjectileShell)
{
