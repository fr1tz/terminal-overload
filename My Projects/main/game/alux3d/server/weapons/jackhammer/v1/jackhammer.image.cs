...
datablock ShapeBaseImageData(WpnJackhammerImage)
{
   // Basic Item properties
   shapeFile = "content/xa/oldshapes/raptor/image/p1/TP_Raptor.DAE";
   shapeFileFP = "content/xa/alux1/shapes/jackhammer/image/p1/shape.fp.dae";
   emap = true;
   ...
   projectile = WpnJackhammerPseudoProjectile;

   casing = WpnJackhammerProjectileShell;
   ...
   // Script fields
   reloadImage = WpnJackhammerReloadImage;
   item = WpnJackhammer;
   ammo = WpnJackhammerAmmo;
   //clip = WpnJackhammerClip;
   magazineCapacity = 30;
   ...
   stateSound[1]                    = WpnJackhammerSwitchinSound;
   ...
   stateSound[3]                    = WpnJackhammerIdleSound;
   ...
   stateFire[5]                     = true;
   stateFireProjectile[5]           = WpnJackhammerPseudoProjectile;
   ...
   stateSound[5]                    = WpnJackhammerFireSound;
   //stateEmitter[5]                  = WpnJackhammerFireSmokeEmitter;
   ...
   stateSound[12]                   = WpnJackhammerReleaseMagazineSound;
   ...
   stateSound[8]                    = WpnJackhammerDryFireSound;
};

function WpnJackhammerImage::onMount(%this, %obj, %slot)
{
   ...
   %obj.setImageInaccuracy(%slot, "b1", 0.97);
   %obj.setImageInaccuracy(%slot, "b2", 0.0);
   %obj.setImageInaccuracy(%slot, "c", 20.0);
   %obj.setImageInaccuracy(%slot, "d", 0.6);
