...
{
   filename = "content/o/torque3d/3.0/sound/weapons/GRENADELAND.wav";
...
{
   filename = "content/o/torque3d/3.0/sound/weapons/Crossbow_explosion";
   description = AudioDefault3d;
   preload = true;
};
...
{
   textureName = "content/o/torque3d/3.0/particles/impact";
   dragCoeffiecient = 0;
   ...
   times[1] = 0.494118;
   times[2] = 1.0;
   animTexName = "content/o/torque3d/3.0/particles/impact";
...
{
   shapeFile = "content/o/torque3d/3.0/shapes/weapons/Grenade/grenadeDebris.dae";
...
datablock ParticleData(GrenadeSplashMist)
{
   ...
   textureName = "content/o/torque3d/3.0/particles/smoke";
...
datablock ParticleData(GrenadeSplashParticle)
{
   ...
   textureName = "content/o/torque3d/3.0/particles/droplet";
...
{
   textureName = "content/o/torque3d/3.0/particles/wake";
   dragCoefficient = 0.0;
...
datablock SplashData(GrenadeSplash)
{
   ...
   emitter[2] = GrenadeSplashRingEmitter;
    ...
    //acceleration = -3.0;
    //texWrap = 5.0;
    //texture = "content/o/torque3d/3.0/images/particles//splash";
...
{
   textureName = "content/o/torque3d/3.0/particles/fireball.png";
   dragCoeffiecient = 0;
   ...
   times[1] = 0.25;
   times[2] = 0.5;
   animTexName = "content/o/torque3d/3.0/particles/fireball.png";
   times[3] = "1";
...
{
   textureName = "content/o/torque3d/3.0/particles/smoke.png";
   ...
   times[1] = 0.494118;
   times[2] = 1.0;
   animTexName = "content/o/torque3d/3.0/particles/smoke.png";
...
{
   textureName = "content/o/torque3d/3.0/particles/Sparkparticle";
   dragCoefficient = 1;
   gravityCoefficient = 0.0;
   inheritedVelFactor = 0.2;
   constantAcceleration = 0.0;
...
datablock ParticleData(GrenadeExpSmoke)
{
   ...
   times[1] = 0.498039;
   times[2] = 1;
   animTexName = "content/o/torque3d/3.0/particles/smoke";
   times[3] = "1";
};
...
{
   textureName = "content/o/torque3d/3.0/particles/steam";
   dragCoefficient = 1.0;
...
{
   textureName = "content/o/torque3d/3.0/particles/spark_wet";
   dragCoefficient = 1;
   gravityCoefficient = 0.0;
   inheritedVelFactor = 0.2;
   constantAcceleration = 0.0;
...
{
   textureName = "content/o/torque3d/3.0/particles/millsplash01";
   dragCoefficient = 0.0;
...
{
   textureName = "content/o/torque3d/3.0/particles/bubble";
   dragCoefficient = 0.0;
