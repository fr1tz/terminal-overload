...
singleton Material(Raptor_ScopeScreen_Base)
{
   ...
   diffuseMap[0] = "content/xa/oldshapes/raptor/image/p1/Raptor_D.dds";
   specular[0] = "1 1 1 1";
   specularPower[0] = "10";
...
singleton Material(Raptor_Base)
{
   mapTo = "Raptor_Base";
   diffuseMap[0] = "content/xa/oldshapes/raptor/image/p1/Raptor_D.dds";
   normalMap[0] = "content/xa/oldshapes/raptor/image/p1/Raptor_N.dds";
   specularMap[0] = "content/xa/oldshapes/raptor/image/p1/Raptor_S.dds";
   specular[0] = "1 1 1 1";
   specularPower[0] = "16";
   translucentBlendOp = "None";
   useAnisotropic[0] = "1";
...
{
   mapTo = "Raptor_MuzzleFlash_Base";
   diffuseMap[0] = "content/xa/oldshapes/raptor/image/p1/Raptor_MuzzleFlash.dds";
   specular[0] = "0.9 0.9 0.9 1";
   specularPower[0] = "4";
   translucent = "1";
   glow[0] = "1";
