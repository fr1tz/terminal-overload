...
singleton Material(alux3d_release1_shapes_soil_mat1)
{
   mapTo = "alux3d_release1_shapes_soil_mat1";
   diffuseColor[0] = "0.996078 0.992157 0.992157 1";
   specular[0] = "1 1 1 1";
   specularPower[0] = "8";
   doubleSided = "0";
   translucentBlendOp = "LerpAlpha";
   diffuseMap[0] = "content/xa/oldshapes/soil/base1.png";
   emissive[0] = "0";
...
singleton Material(alux3d_release1_shapes_soil_mat2)
{
   ...
   materialTag0 = "Miscellaneous";
   castShadows = "0";
   diffuseMap[0] = "content/xa/oldshapes/soil/base2.png";
};
...
singleton Material(alux3d_release1_shapes_soil_mat0)
{
   ...
   doubleSided = "0";
   translucentBlendOp = "LerpAlpha";
   diffuseMap[0] = "content/xa/alux1/textures/core/collision.png";
   emissive[0] = "1";
   castShadows = "0";
   translucent = "0";
   showFootprints = "0";
   materialTag0 = "Miscellaneous";
   detailMap[0] = "content/xa/alux1/textures/core/collision.png";
   detailScale[0] = "8 8";
};
