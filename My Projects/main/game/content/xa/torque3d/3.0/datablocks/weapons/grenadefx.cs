...
{
   filename = "content/xa/torque3d/3.0/sound/weapons/GRENADELAND.wav";
...
{
   filename = "content/xa/torque3d/3.0/sound/weapons/Crossbow_explosion";
   description = AudioDefault3d;
   preload = true;
};
...
{
   shapeFile = "content/xa/torque3d/3.0/shapes/weapons/Grenade/grenadeDebris.dae";
...
datablock ParticleData(GrenadeSplashMist)
{
   ...
   textureName = "content/xa/torque3d/3.0/particles/smoke";
...
datablock ParticleData(GrenadeSplashParticle)
{
   ...
   textureName = "content/xa/torque3d/3.0/particles/droplet";
...
{
   textureName = "content/xa/torque3d/3.0/particles/wake";
   dragCoefficient = 0.0;
...
datablock SplashData(GrenadeSplash)
{
   ...
   emitter[2] = GrenadeSplashRingEmitter;
    ...
    //acceleration = -3.0;
    //texWrap = 5.0;
    //texture = "content/xa/torque3d/3.0/images/particles//splash";
...
{
   textureName = "content/xa/torque3d/3.0/particles/fireball.png";
   dragCoeffiecient = 0;
   ...
   times[1] = 0.25;
   times[2] = 0.5;
   animTexName = "content/xa/torque3d/3.0/particles/fireball.png";
   times[3] = "1";
...
{
   textureName = "content/xa/torque3d/3.0/particles/Sparkparticle";
   dragCoefficient = 1;
   gravityCoefficient = 0.0;
   inheritedVelFactor = 0.2;
   constantAcceleration = 0.0;
...
datablock ParticleData(GrenadeExpSmoke)
{
   ...
   times[1] = 0.498039;
   times[2] = 1;
   animTexName = "content/xa/torque3d/3.0/particles/smoke";
   times[3] = "1";
};
...
{
   textureName = "content/xa/torque3d/3.0/particles/steam";
   dragCoefficient = 1.0;
...
{
   textureName = "content/xa/torque3d/3.0/particles/spark_wet";
   dragCoefficient = 1;
   gravityCoefficient = 0.0;
   inheritedVelFactor = 0.2;
   constantAcceleration = 0.0;
...
{
   textureName = "content/xa/torque3d/3.0/particles/millsplash01";
   dragCoefficient = 0.0;
...
{
   textureName = "content/xa/torque3d/3.0/particles/bubble";
   dragCoefficient = 0.0;
...
{
   projectileShapeName = "content/xa/torque3d/3.0/shapes/weapons/shared/rocket.dts";
   directDamage = 30;
   radiusDamage = 30;
   damageRadius = 5;
   areaImpulse = 2000;
