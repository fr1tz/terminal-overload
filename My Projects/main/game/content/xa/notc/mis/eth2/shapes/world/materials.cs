...
singleton Material(notc_mis_eth2_shapes_world_mat1)
{
   mapTo = "notc_mis_eth2_shapes_world_mat1";
   ...
   emissive[1] = "1";
   wireframe[1] = "0";
   diffuseMap[0] = "content/xa/notc/mis/te2/shapes/terrain/noise.png";
...
singleton Material(notc_mis_eth2_shapes_world_mat3)
{
   mapTo = "notc_mis_eth2_shapes_world_mat3";
   diffuseColor[0] = "0.227451 0.972549 0.992157 1";
   specular[0] = "0.5 0.5 0.5 1";
   specularPower[0] = "50";
   ...
   showFootprints = "0";
   translucent = "1";
   diffuseMap[0] = "content/xa/notc/mis/eth2/shapes/world/gradient1.png";
   specular[3] = "1 1 1 1";
};
