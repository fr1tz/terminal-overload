...
singleton Material(xa_notc_core_shapes_sr1_projectile_p1_decalmat)
{
   diffuseMap[0] = "content/xa/notc/core/shapes/sr1/projectile/p1/decal.png";
   translucent = "1";
...
singleton Material(xa_notc_core_shapes_sr1_projectile_p1_lasertrail0mat)
{
...
singleton Material(xa_notc_core_shapes_sr1_projectile_p1_lasertrail1mat)
{
   diffuseColor[0] = "0.996078 0.996078 0.996078 1";
   doubleSided = "1";
   translucentBlendOp = "AddAlpha";
...
singleton Material(xa_notc_core_shapes_sr1_projectile_p1_lasertrail2mat)
{
   ...
   scrollDir[0] = "1 1";
   scrollSpeed[0] = "0.235";
   diffuseColor[1] = "0.937255 0.00392157 0.996078 0";
   glow[1] = "1";
   emissive[1] = "1";
   vertColor[1] = "1";
