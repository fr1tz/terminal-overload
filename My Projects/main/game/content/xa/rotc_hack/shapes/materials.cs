...
singleton Material(xa_rotc_hack_shapes_mat1)
{
...
singleton Material(xa_rotc_hack_shapes_mat2)
{
   mapTo = "flash.front";
   diffuseColorPaletteSlot[0] = "0";
   diffuseMap[0] = "content/o/rotc/p.5.4/shapes/rotc/weapons/minigun/flash.front";
   glow[1] = "1";
   emissive[1] = "1";
   translucent = "1";
   translucentBlendOp = "AddAlpha";
...
singleton Material(xa_rotc_hack_shapes_mat3)
{
   mapTo = "image.barrel.blue";
   diffuseMap[0] = "content/o/rotc/p.5.4/shapes/rotc/weapons/minigun/image.barrel.blue";
   glow[1] = "1";
   emissive[1] = "1";
   castShadows = "0";
   translucent = "1";
   ...
   translucentZWrite = "0";
   alphaRef = "20";
   diffuseMap[1] = "content/o/rotc/p.5.4/textures/rotc/rainbow1.png";
   materialTag0 = "Miscellaneous";
};
...
{
   mapTo = "image2";
   diffuseMap[0] = "content/o/rotc/p.5.4/shapes/rotc/weapons/disc/image2.png";
   showFootprints = "0";
...
singleton Material(xa_rotc_hack_shapes_mat8)
{
   ...
   diffuseMap[0] = "content/o/rotc/p.5.4/shapes/rotc/effects/explosion2_white.png";
   glow[0] = "1";
   emissive[0] = "1";
   castShadows = "0";
   translucent = "1";
...
{
   mapTo = "grid.bluegrey";
   diffuseMap[0] = "content/o/rotc/p.5.4/shapes/eth/grid.bluegrey.png";
   glow[0] = "0";
   doubleSided = "1";
   castShadows = "0";
   translucent = "1";
