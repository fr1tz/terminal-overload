...
function GameCoreBase::prepareMissionLoad(%game)
{
   ...
   // Create SimSet for widgets
   if(isObject(%game.widgets))
      %game.widgets.delete();
   %game.widgets = new SimSet();
}
...
function GameCoreBase::prepareClient(%game, %client)
{
   ...
   %files = "vitc/core/client/base/v1/exec" TAB
            "vitc/core/client/settings/notc1/exec" TAB
            "vitc/core/client/audio/Descriptions/v1/exec" TAB
            "vitc/core/client/audio/Hearing/v1/exec" TAB
            "vitc/core/client/audio/HitSound/v1/exec" TAB
            "vitc/core/client/gui/LoadingGui/v1/exec" TAB
            "vitc/core/client/gui/UserGui/v1/exec" TAB
            "vitc/core/client/gui/CatHud/v1/exec" TAB
            "vitc/core/client/gui/CatGui/v1/exec" TAB
            "vitc/core/client/gui/CatGuiSniper/v1/exec" TAB
            "vitc/core/client/gui/EtherformGui/v1/exec" TAB
            "vitc/core/client/gui/ChatHud/v1/exec" TAB
            "vitc/core/client/gui/GuiChanger/v1/exec" TAB
            "vitc/core/client/gui/VitalsHud/v1/exec" TAB
            "vitc/core/client/gui/MinimapHud/v1/exec" TAB
            "vitc/core/client/gui/LoadoutHud/v1/exec" TAB
            "vitc/core/client/gui/MiscHud/v1/exec" TAB
            "vitc/core/client/gui/HudIcons/v1/exec" TAB
            "vitc/core/client/gui/PlayerList/v1/exec" TAB
            "vitc/core/client/misc/Commands/v1/exec" TAB
            "vitc/core/client/misc/Materials/v1/exec" TAB
            "vitc/core/client/postfx/Blur/v1/exec" TAB
            "vitc/core/client/postfx/Pixelate/v1/exec" TAB
            "vitc/core/client/postfx/ChromaticLens/v1/exec" TAB
            "vitc/deathmatch/client/gui/EndGameGui/v1/exec" TAB
            "vitc/deathmatch/client/gui/PlayerList/v1/exec";
   ...
   commandToClient(%client, '_VitcLoadingGui_SetBackground', %background);
}
