...
datablock SFXProfile(cheetahSqueal)
{
   ...
   fileName = "content/o/torque3d/3.0/sound/cheetah/cheetah_squeal.ogg";
};
...
datablock SFXProfile(Wheels1TurretFireSound)
{
...
datablock ShapeBaseImageData(Wheels1TurretImage)
{
   // Basic Item properties
   shapeFile = "content/o/torque3d/3.0/shapes/Cheetah/Cheetah_Turret.DAE";
   emap = true;
   ...
   stateSound[3]                    = Wheels1TurretFireSound;
...
//-----------------------------------------------------------------------------
datablock WheeledVehicleTire(Wheels1Tire)
{
   // Tires act as springs and generate lateral and longitudinal
   // forces to move the vehicle. These distortion/spring forces
   // are what convert wheel angular velocity into forces that
   // act on the rigid body.
   shapeFile = "content/o/torque3d/3.0/shapes/Cheetah/wheel.DAE";
   staticFriction = 4.2;
   kineticFriction = "1";
...
datablock WheeledVehicleTire(Wheels1TireRear)
{
   // Tires act as springs and generate lateral and longitudinal
   // forces to move the vehicle. These distortion/spring forces
   // are what convert wheel angular velocity into forces that
   // act on the rigid body.
   shapeFile = "content/o/torque3d/3.0/shapes/Cheetah/wheelBack.DAE";
   staticFriction = "7.2";
   kineticFriction = "1";
...
datablock WheeledVehicleSpring(Wheels1Spring)
{
...
datablock WheeledVehicleData(Wheels1)
{
   category = "Vehicles";
   shapeFile = "content/o/torque3d/3.0/shapes/Cheetah/Cheetah_Body.DAE";
   emap = 1;
...
function Wheels1::onAdd(%this, %obj)
{
   ...
   for(%i = 0; %i <= 1; %i++)
   {
      ...
      %obj.setWheelSteering(%i, true);
   }
   
   for(%i = 2; %i <= 3; %i++)
   {
      %obj.setWheelTire(%i, Wheels1TireRear);
      %obj.setWheelSpring(%i, Wheels1Spring);
...
{
   %speed = getWord(%args, 0);
   %speed = %speed / 4;
   %this.unitObj.ssc.y = %speed;
echo(%this.unitObj);
}
